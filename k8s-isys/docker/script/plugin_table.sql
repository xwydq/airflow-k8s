...
(
	...
	retries int default 2 null,
	retry_delay_minutes int default 3 null,
	email_on_failure tinyint(1) default 1 null,
	email_on_retry tinyint(1) default 1 null,
	depends_on_past tinyint(1) default 1 null,
	concurrency int default 16 null,
	max_active_runs int default 16 null,
	skip_dag_not_latest tinyint(1) default 1 null,
